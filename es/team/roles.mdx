...
- **Vendedor:** trabaja sus oportunidades y clientes, con una vista enfocada en su propio rendimiento.

## El Dueño

El Dueño es quien tiene la visión completa del negocio:

- **Mission Control:** ve toda la organización: todos los vendedores y todos los montos. El email del resumen semanal llega únicamente al Dueño.
