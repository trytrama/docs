...
Available on **Pro** and **Business**, because it needs [sales rep tracking](/tracking/sales-reps).
...
On the free plan and on Starter, or if your reps haven't connected their WhatsApp, you move the cards yourself: by dragging them on the board, or by telling the Trama Agent.
