...
Disponível nos planos **Pro** e **Business**, porque precisa do [acompanhamento de vendedores](/pt-BR/tracking/sales-reps).
...
Nos planos gratuito e Starter, ou se os seus vendedores não conectaram o WhatsApp, os cartões você move: arrastando no quadro, ou avisando o Trama Agent.
