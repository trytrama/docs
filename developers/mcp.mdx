...
description: "Trama exposes an MCP (Model Context Protocol) server that lets you query your organization's Operations Agent from external clients like Claude.ai and…"
---
...
On top of that, `ask_trama` remains: it asks the Operations Agent in natural language. It's for whatever no specific tool covers: compound requests, chained actions, or questions about how Trama works.
